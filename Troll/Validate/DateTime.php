 ...
 * @since  30/03/2011
 */
class Troll_Validate_DateTime extends Zend_Validate_Abstract
{
    const INVALID          = 'dateInvalid';
    const INVALID_DATETIME = 'dateInvalidDate';
    ...
    protected $_messageTemplates = array(
        ...
        self::INVALID_DATETIME => "'%value%' does not appear to be a valid date",
        ...
        if (($this->_format !== null) || ($this->_locale !== null) || is_array($value) ||
            ...
            if (!Zend_Date::isDate($value, $this->_format, $this->_locale)) {
                if ($this->_checkFormat($value) === false) {
                    ...
                    $this->_error(self::INVALID_DATETIME);
                }
                return false;
            }
        } else {
            ...
            list($year, $month, $day, $hour, $minutes, $seconds) = sscanf($value, '%d-%d-%d %d:%d:%d');
